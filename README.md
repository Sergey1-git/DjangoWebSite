...
![Главная страница](screenshot/screenshot-garden_page.png "Садовые цветы")
4. Боелее подробную информацию о товаре можно получить нажав на фотографию товара и перейти на его персональную страницу.
![Главная страница](screenshot/screenshot-product_page.png "Страница товара")
...
![Главная страница](screenshot/screenshot-register_page.png "Страница регистрации")
...
![Главная страница](screenshot/screenshot-login_page.png "Страница авторизации")
7. После выбора товара покупатель может перейти в "Корзину" для оформления заказа.
![Главная страница](screenshot/screenshot-basket1.png "Страница Корзина")
При необходимости можно откорректировать колличество товара изменив его в поле вводаб если установить значение на 0 товар будет удален из заказа.
![Главная страница](screenshot/screenshot-basket2.png "Страница Корзина")
При коректировке заказа необходимо нажать кнопку "Внести изменение в заказ", форма заказа обновится.
![Главная страница](screenshot/screenshot-basket3.png "Страница Корзина")
Завершается формирование заказа нажатием кнопки "Подтвердить заказ", после чего заказ будет занесен в базу данных.
![Главная страница](screenshot/screenshot-basket4.png "Страница Корзина")
...
![Главная страница](screenshot/screenshot-add_product_page.png "Страница Корзина")
